<script lang="ts" setup>
  ...
  async function fetchAnalysisName() {
    try {
        const response = await axios.get('http://127.0.0.1:4523/m1/3616438-0-default/api/getAnalysisName/');
  ...
  async function sendAnalysisList() {
    try {
        const response = await axios.post('http://127.0.0.1:4523/m1/3616438-0-default/api/sendAnalysisList/');
